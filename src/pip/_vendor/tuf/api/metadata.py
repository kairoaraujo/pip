...
from pip._vendor.securesystemslib import exceptions as sslib_exceptions
from pip._vendor.securesystemslib import hash as sslib_hash
from pip._vendor.securesystemslib import keys as sslib_keys
from pip._vendor.securesystemslib.signer import Signature, Signer
from pip._vendor.securesystemslib.storage import FilesystemBackend, StorageBackendInterface
from pip._vendor.securesystemslib.util import persist_temp_file

from pip._vendor.tuf.api import exceptions
from pip._vendor.tuf.api.serialization import (
    ...
    *All parameters named below are not just constructor arguments but also
    ...
    def from_bytes(
        ...
        if deserializer is None:
            ...
            from pip._vendor.tuf.api.serialization.json import JSONDeserializer
    ...
    def to_bytes(
        ...
        if serializer is None:
            # Use local scope import to avoid circular import errors
            # pylint: disable=import-outside-toplevel
            from pip._vendor.tuf.api.serialization.json import JSONSerializer
    ...
    def sign(
        ...
        if signed_serializer is None:
            # Use local scope import to avoid circular import errors
            # pylint: disable=import-outside-toplevel
            from pip._vendor.tuf.api.serialization.json import CanonicalJSONSerializer
