...
from pip._vendor.tuf.api.metadata import (
    Metadata,
    Root,
    Snapshot,
    TargetFile,
...
from pip._vendor.tuf.ngclient._internal import requests_fetcher, trusted_metadata_set
from pip._vendor.tuf.ngclient.config import UpdaterConfig
